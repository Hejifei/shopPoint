...
!function (t, i) {
    ...
    function p(t, i, e, s, o, n) {
        var r = t - i, h = Math.abs(r) / e, a = n.deceleration, l = n.itemHeight, p = n.swipeBounceTime, c = n.wheel,
            u = n.swipeTime, d = c ? 4 : 15, m = t + h / a * (r < 0 ? -1 : 1);
    ...
    var m = function () {
            ...
            return Array.from(t)
        }, f = document.createElement("div").style, v = function () {
            var t = {
            ...
            for (var i in t) if (void 0 !== f[t[i]]) return i;
            return !1
        }(), y = t("transform"), w = t("perspective") in f, T = "ontouchstart" in window, x = !1 !== y,
        b = t("transition") in f, S = {
            transform: y,
        ...
        }, X = 1, Y = {touchstart: X, touchmove: X, touchend: X, mousedown: 2, mousemove: 2, mouseup: 2}, M = {
            startX: 0,
            startY: 0,
            scrollX: !1,
            scrollY: !0,
    ...
    return function (t) {
        ...
        t.prototype._start = function (t) {
            ...
            if (this.enabled && !this.destroyed && Y[t.type] === this.initiated) {
                ...
                var o = Math.abs(this.distX), n = Math.abs(this.distY), r = c();
                if (!(r - this.endTime > this.options.momentumLimitTime && n < this.options.momentumLimitDistance && o < this.options.momentumLimitDistance)) {
                    ...
                    var l = document.documentElement.scrollLeft || window.pageXOffset || document.body.scrollLeft,
                        ...
                        u = this.pointX - l, d = this.pointY - p;
            ...
            if (this.enabled && !this.destroyed && Y[t.type] === this.initiated && (this.initiated = !1, this.options.preventDefault && !n(t.target, this.options.preventDefaultException) && t.preventDefault(), this.trigger("touchEnd", {
                ...
                var i = Math.round(this.x), e = Math.round(this.y);
                if (this.moved) {
                    this.scrollTo(i, e);
                    var o = i - this.absStartX, a = e - this.absStartY;
                    this.directionX = o > 0 ? -1 : o < 0 ? 1 : 0, this.directionY = a > 0 ? -1 : a < 0 ? 1 : 0, this.endTime = c();
                    var l = this.endTime - this.startTime, u = Math.abs(i - this.startX), d = Math.abs(e - this.startY);
            ...
            function o() {
                ...
                var u = s(p = (p - a) / e), d = (t - r) * u + r, m = (i - h) * u + h;
            ...
            var n = this, r = this.x, h = this.y, a = c(), l = a + e;
            ...
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : E.bounce, e = this.x;
        ...
        t.prototype.on = function (t, i) {
            ...
            var s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this, o = !1;
            this.on(t, e)
        }, t.prototype.off = function (t, i) {
            var e = this._events[t];
            if (e) for (var s = e.length; s--;) e[s][0] === i && (e[s][0] = void 0)
        }, t.prototype.trigger = function (t) {
            var i = this._events[t];
            if (i) for (var e = i.length, s = [].concat(g(i)), o = 0; o < e; o++) {
                var n = s[o], r = m(n, 2), h = r[0], a = r[1];
        ...
        t.prototype._initSnap = function () {
            ...
            "string" == typeof s && (s = this.scroller.querySelectorAll(s)), this.on("refresh", function () {
                if (t.pages = [], t.wrapperWidth && t.wrapperHeight && t.scrollerWidth && t.scrollerHeight) {
                    var e = i.stepX || t.wrapperWidth, n = i.stepY || t.wrapperHeight, r = 0, h = void 0, a = void 0,
                        l = void 0, p = 0, c = void 0, u = 0, d = void 0, m = void 0;
                    if (s) for (c = s.length, d = -1; p < c; p++) m = o(s[p]), (0 === p || m.left <= o(s[p - 1]).left) && (u = 0, d++), t.pages[u] || (t.pages[u] = []), r = Math.max(-m.left, t.maxScrollX), h = Math.max(-m.top, t.maxScrollY), a = r - Math.round(m.width / 2), l = h - Math.round(m.height / 2), t.pages[u][d] = {
                        x: r,
                        y: h,
                        width: m.width,
                        height: m.height,
                        cx: a,
                        cy: l
                    }, r > t.maxScrollX && u++; else for (a = Math.round(e / 2), l = Math.round(n / 2); r > -t.scrollerWidth;) {
            ...
            var s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : E.bounce, o = this.options.snap;
