(function(){
    ...
    function DrowProcess(x,y,radius,process,backColor,proColor,fontColor,id){
        ...
        //在中间写字 
        cts.font = "14px PingFangSC-Regular";
    ...
    bfb = 0;
    function start(bgcolor,progresscolor,finallevel,id){
        DrowProcess(30,30,30,bfb,bgcolor,progresscolor,progresscolor,id);

        t = setTimeout(function(){
            start(bgcolor,progresscolor,finallevel,id);
        },5);
        if(bfb>=finallevel){
            clearTimeout(t);
            bfb=0;
