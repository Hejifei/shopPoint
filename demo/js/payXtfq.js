...
var newtotalAmount = getUrl(location.href).newtotalAmount;
var newtotalIntegral = getUrl(location.href).newtotalIntegral;
var ifpayType = getUrl(location.href).ifpayType;
var ifexchangeType = getUrl(location.href).ifexchangeType;
var submiting = false;
$(function () {
  ...
  var payForGoods = function payForGoods() {
    var fromorder = payinfo.fromorder;
    var postdata = '';
    /**
